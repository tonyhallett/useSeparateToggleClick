...
import {
  ...
  ToggleReason,
} from '../src/useSeparateToggleClick';
...
describe('useSeparateToggleClick', () => {
  ...
  const TestComponent: React.FC<TestUseSeparateToggleClickProps> = props => {
    const { expanded, onNodeToggle, IconWrapper } = useSeparateToggleClick(
      props.shouldToggleClick,
      props.initiallyExpanded,
      props.shouldToggleNonClick
    );
    return (
      ...
      <TreeView
        defaultParentIcon={
          <IconWrapper>
            <div data-testid="defaultparenticon" />
          </IconWrapper>
        }
      ...
      >
        ...
        <TreeItem
          icon={
            <IconWrapper>
              <div
                onClick={() => (wrappedClicked = true)}
                data-testid="parenticon2"
              />
            </IconWrapper>
          }
          label="parent2"
  ...
  function expectShouldChangeExpanded(
  ...
  function expectShouldNotChangeExpanded(
    renderResult: RenderResult,
    changeExpanded: () => void
  ) {
    expectNotExpanded(renderResult);
  ...
  describe('click', () => {
    ...
    function renderShouldToggleClick() {
      renderResult = render(
        <TestComponent shouldToggleClick={shouldToggleClick} />
      );
    }
